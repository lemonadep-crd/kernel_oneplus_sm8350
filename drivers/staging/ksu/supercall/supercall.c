...
/* Currently, these functions are implemented in fs/susfs.c */
extern void susfs_add_try_umount(void __user **user_info);
...
void ksu_susfs_add_try_umount(void __user **user_info)
{
	susfs_add_try_umount(user_info);
}
#endif
